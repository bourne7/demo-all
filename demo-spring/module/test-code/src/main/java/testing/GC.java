...
/**
 * @author https://www.cnblogs.com/Smina/p/7189427.html
 */
public class GC {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // 由于 Any exception thrown by the finalize method causes the finalization of this object to be halted, but is otherwise ignored.
        // 所以这一次的 finalized 标记导致不会执行 finalize()，所以对象被直接回收。
        SAVE_HOOK = null;
